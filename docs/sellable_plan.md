...
> 📎 **これは 2026-07 時点の調査時点の記録（アーカイブ）です。**
> 以降に変わったこと: 決済は Lemon Squeezy ではなく **Polar.sh** を採用し実装済み、
> 冒頭の「ビルドが壊れています」は解消済み、ライセンス機構・公証・DMG も完成している。
> **いま何が残っているかは `docs/go_live_checklist.md` を見ること。**
> 本文中の Gumroad / Lemon Squeezy への言及は、当時の検討内容としてそのまま残してある。
